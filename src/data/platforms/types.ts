/**
 * Shared types and icon SVG paths for the feature landing page system.
 */
...
export const icons = {
  ...
  viewer: `<path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>`,
  monitor: `<path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>`,
  ...
  globe: `<path stroke-linecap="round" stroke-linejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064"/>`,
  ...
  hashtag: `<path stroke-linecap="round" stroke-linejoin="round" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14"/>`,
  ...
  finger: `<path stroke-linecap="round" stroke-linejoin="round" d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5M7.188 2.239l.777 2.897M5.136 7.965l-2.898-.777M13.95 4.05l-2.122 2.122m-5.657 5.656l-2.12 2.122"/>`,
  ...
  film: `<path stroke-linecap="round" stroke-linejoin="round" d="M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z"/>`,
  trendUp: `<path stroke-linecap="round" stroke-linejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>`,
  ...
  ad: `<path stroke-linecap="round" stroke-linejoin="round" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"/>`,
};
...
export const brandIcons = {
  ...
  tiktok: `<path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.46V13.2a8.16 8.16 0 005.58 2.2V12a4.85 4.85 0 01-3.58-1.59V6.69h3.58z"/>`,
  facebook: `<path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>`,
  snapchat: `<path d="M12.206.793c.99 0 4.347.276 5.93 3.821.529 1.193.403 3.219.299 4.847l-.003.06c-.012.18-.022.345-.03.51.075.045.203.09.401.09.3-.016.659-.12 1.033-.301a.32.32 0 01.134-.027c.193 0 .33.089.346.271.015.18-.155.345-.345.404a4.7 4.7 0 01-.715.195c-.27.056-.464.155-.614.339-.195.24-.24.54-.24.794 0 .15.021.3.046.435.18.9.57 1.725 1.17 2.46.33.405.735.735 1.2.976.21.12.375.255.375.495 0 .12-.06.27-.195.375-.36.27-.945.39-1.335.45-.06.016-.12.03-.165.06-.09.06-.12.18-.15.3-.03.12-.075.27-.18.39-.195.21-.525.21-.795.21a3.3 3.3 0 01-.63-.06c-.39-.075-.81-.165-1.35-.165-.195 0-.39.015-.585.045-1.05.15-1.86.81-2.76 1.545-.615.51-1.245 1.02-2.07 1.32a5.7 5.7 0 01-.51.135 5.7 5.7 0 01-.51-.135c-.81-.3-1.455-.81-2.07-1.32-.9-.735-1.71-1.395-2.76-1.545a4.65 4.65 0 00-.585-.045c-.54 0-.96.09-1.35.165a3.3 3.3 0 01-.63.06c-.27 0-.6 0-.795-.21-.105-.12-.15-.27-.18-.39-.03-.12-.06-.24-.15-.3-.045-.03-.105-.044-.165-.06-.39-.06-.975-.18-1.335-.45a.49.49 0 01-.195-.375c0-.24.165-.375.375-.495.465-.24.87-.57 1.2-.976.6-.735.99-1.56 1.17-2.46.025-.135.046-.285.046-.435 0-.255-.045-.555-.24-.795-.15-.184-.345-.283-.614-.339a4.7 4.7 0 01-.715-.195c-.18-.06-.36-.225-.345-.405.015-.18.15-.27.345-.27a.32.32 0 01.135.027c.375.18.72.3 1.035.3.195 0 .315-.044.39-.09-.012-.21-.024-.39-.036-.585l-.003-.03c-.105-1.62-.225-3.654.3-4.86C7.65 1.075 11.007.793 11.997.793h.21z"/>`,
};
